  ...
  return (
    <div className="h-screen flex items-center justify-center bg-[#072B31] px-4">
      <div className="bg-white/5 backdrop-blur-sm border border-white/10 shadow-2xl rounded-2xl max-w-md w-full p-8 animate-fade-in text-white">
        <h2 className="text-2xl font-bold text-center text-[#16C9E2] mb-6">Регистрация</h2>
        <form action={onRegistrationFormHandler} className="space-y-5">
          <div>
            <label className="block text-sm font-medium mb-1 text-white/80">Имя</label>
            <input
              name="name"
              type="text"
              placeholder="Иван"
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-white/80">Пароль</label>
            <input
              name="password"
              type="password"
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-white/80">Повторите пароль</label>
            <input
        ...
        <p className="mt-6 text-sm text-center text-white/60">
          Уже есть аккаунт?{' '}
          <Link href="/login" className="text-[#16C9E2] hover:underline font-medium">
            Войти
          </Link>
        </p>
      </div>
